...
exec java ${JAVA_OPTS:-} -jar trader-statistic.jar --node.config.path=/app/config/config.properties --spring.config.location=file:/app/config/application.yml --logging.config=file:/app/config/logback-spring.xml
