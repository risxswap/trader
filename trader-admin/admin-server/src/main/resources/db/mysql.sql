...
CREATE TABLE IF NOT EXISTS investment (
  ...
  broker_id INT DEFAULT NULL COMMENT '券商ID',
...
CREATE TABLE IF NOT EXISTS investment_log (
  id INT NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  investment_id INT NOT NULL COMMENT '投资ID',
...
CREATE TABLE IF NOT EXISTS investment_trading (
  id INT NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  investment_log_id INT DEFAULT NULL COMMENT '投资日志ID',
  investment_id INT NOT NULL COMMENT '投资ID',
...
CREATE TABLE IF NOT EXISTS task_log (
    ...
    trace_id VARCHAR(128) COMMENT '执行链路ID',
    ...
    INDEX idx_task_log_trace_id (trace_id),
...
CREATE TABLE IF NOT EXISTS node (
  ...
  node_group_id INT NOT NULL COMMENT '节点分组ID',
...
CREATE TABLE IF NOT EXISTS system_task (
    ...
    KEY system_task_result_idx (result)
