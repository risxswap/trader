  ...
  <div class="page-container">
    <div class="page-header">
      <div class="page-header__content">
        <div class="title">公募基金列表</div>
        <div class="subtitle">统一查看公募基金基础档案、费率结构、管理机构与维护状态</div>
      </div>
      <div class="page-header__meta">
        <el-tag effect="plain" type="primary">公募基金</el-tag>
    ...
    <el-card class="search-card">
      <div class="search-header">
        <div>
          ...
          <div class="section-subtitle">支持按代码、机构、投资类型和费用区间快速筛选公募基金列表</div>
        </div>
    ...
    >
      <div class="drawer-header">
        <div>
          ...
          <div class="section-subtitle">统一维护公募基金名称、状态和市场归属信息</div>
        </div>
        <div class="drawer-header__meta">
          <el-tag effect="plain" type="primary">{{ editForm.code || '-' }}</el-tag>
          <el-tag effect="plain" type="info">公募基金</el-tag>
        </div>
      </div>
